...
% Publication placeholders: replace these two definitions once the Paper 3
% repository URL and archived-release DOI are known. Use \url{...} for GitHub
% and \href{https://doi.org/...}{\texttt{...}} for the DOI, as in Paper 2.
\newcommand{\PaperThreeLeanGitHub}{\texttt{[GitHub URL to be added]}}
\newcommand{\PaperThreeLeanDOI}{\texttt{[DOI to be added]}}
...
A machine-checked Lean development accompanies the paper
...
The entropic framework and guessing-number sandwich theorem are now in
Paper~1 \cite{Paper1}; ordinary dispersion and its exact and asymptotic
decision problems are in Paper~2 \cite{Paper2}.
...
Paper~2 \cite{Paper2} identifies an image of size $|A|^k$ for such a
map with bijectivity, and gives padding reductions from the case $k=3$
...
The development and an archived release will be made available at:
\begin{quote}
\noindent\textbf{GitHub:} \PaperThreeLeanGitHub\\
...
An interactive edition will accompany the source at the GitHub address
above. It links the text of this paper to explanations, exact formal
